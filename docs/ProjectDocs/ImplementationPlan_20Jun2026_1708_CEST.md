...
## Updated to Include UI About Tab and Broad AI Vendors
...
This document outlines the implementation plan to add an integrated AI Chatbot assistant to the **USB Speed Test & Monitor** application, supporting major AI vendors (Ollama, OpenAI, Claude, Gemini, DeepSeek, Groq, OpenRouter) and incorporating a static **About** tab inside the dashboard GUI.
...
- **[COMPLETED] About Panel**: Add `<div id="about-tab" class="tab-content">` displaying:
  - Non-technical description of the application.
  - Developed by: Srinath Pelluri
  - GitHub Link: `https://github.com/pellurisrinath/USBSpeedTester`
  - LinkedIn: `https://www.linkedin.com/in/pellurisrinath/`
